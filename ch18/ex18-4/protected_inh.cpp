...
int main()    //主程式開始
{
    ...
    //呼叫Second_Derived物件的call_fun成員函數，
    //測試Second_Derived類別之成員函數
    //是否可呼叫繼承自Derived類別的成員函數

    A_Second_Derived.show();
    //呼叫Second_Derived物件的show成員函數，
    //測試Second_Derived類別之成員函數
    //是否可存取繼承自Derived類別的屬性
